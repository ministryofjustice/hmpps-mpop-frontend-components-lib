...
<body class="govuk-template__body">
      ...
      <div class="govuk-form-group">
        <fieldset class="govuk-fieldset">
          ...
          <div class="govuk-radios govuk-radios--inline" data-stage-selector>
            ...
            <div class="govuk-radios__item">
              <input class="govuk-radios__input" id="stage-final-third-nsd" type="radio" name="stage" value="final-third-nsd">
              <label class="govuk-label govuk-radios__label" for="stage-final-third-nsd">Final third (NSD)</label>
            </div>
          </div>
        </fieldset>
      </div>
  ...
  "currentPhase": { "phase": { "code": "FTHRD" } },
      ...
      <div class="stage-panel" data-stage="final-third-nsd" hidden>
        <p class="govuk-body">Display the supervision package when the PoP is in the Final third phase of the sentence and is on the National Security Division caseload</p>
        <p class="govuk-body">This is triggered by the following fields in the supervision package API response:</p>
        <pre class="govuk-body" style="background:#f3f2f1;padding:10px;overflow:auto;white-space:pre-wrap;word-break:break-word;"><code>{
  "currentPhase": { "phase": { "code": "FTHRD" } },
  "context": { "nationalSecurityDivision": true }
}</code></pre>
        <p class="govuk-body">This variant is triggered by <code>currentPhase.phase.code === 'FTHRD'</code> alongside <code>context.nationalSecurityDivision === true</code>, which shows the final third progress card instead of the plain final third badge.</p>
        {{ supervisionPackage({
          tierScore: 'C',
          tag: { text: null, color: null },
          historyHref: '#',
