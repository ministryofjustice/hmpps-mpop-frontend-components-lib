...
describe('MpopComponents', () => {
    ...
    describe('getCalculationDetails', () => {
        it('should return calculation and status 200 on success', async () => {
            ...
            const result = await mpopComponents.getCalculationDetails('authToken', 'X123456')
            ...
            expect(mockedRestClient.prototype.get).toHaveBeenCalledWith('/crn/X123456/tier/details', 'authToken')
        })
